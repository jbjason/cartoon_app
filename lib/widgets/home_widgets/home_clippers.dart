...
class HomeItemClip extends CustomClipper<Path> {
  @override
...
class HomeBodyMiddleClip extends CustomClipper<Path> {
  @override
  Path getClip(Size size) {
    final path = Path();
    final w = size.width, h = size.height;
...
class HomeBodyBottomClip extends CustomClipper<Path> {
  @override
  Path getClip(Size size) {
    final path = Path();
    final w = size.width, h = size.height;
...
class HomeCircularprogress extends CustomPainter {
...
class HomeNavSelcted extends CustomClipper<Path> {
  @override
  getClip(Size size) {
    final w = size.width, h = size.height;
    final path = Path();
